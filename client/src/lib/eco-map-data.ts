...
export const ECO_LOCATIONS: EcoLocation[] = [
  ...
  {
    id: "bsb_recycling_bin_003",
    name: "UBD Inspiring Hall Recycling Bin",
    category: "recycling_bin",
    coordinates: [4.975922, 114.89494],
    address: "Jalan Universiti, Bandar Seri Begawan BS8719",
    district: "Brunei-Muara",
    hours: "24/7",
  ...
  {
    id: "bsb_recycling_bin_004",
    name: "University Male Hostel Recycling Bin",
    category: "recycling_bin",
    coordinates: [4.978365, 114.895023],
    address: "Jalan Universiti, Bandar Seri Begawan BS8719",
    district: "Brunei-Muara",
    hours: "24/7",
    services: ["Public Bins"],
  ...
  // New entries for greater coverage
  {
    id: "berakas_bin_001",
    name: "Berakas Free Public Bin",
    category: "recycling_bin",
    coordinates: [4.899, 114.94],
    address: "Jalan Berakas A, Brunei-Muara",
    district: "Brunei-Muara",
    hours: "24/7",
    services: ["Public Bins"],
    wasteTypes: ["Recyclables", "General Waste"],
  },
  {
    id: "kiulap_drop_off_002",
    name: "Kiulap Food Waste Drop-off",
    category: "drop_off_point",
    coordinates: [4.9055, 114.9345],
    address: "Kiulap Food Market, Jalan Kiulap",
    district: "Brunei-Muara",
    hours: "Daily: 7:00 AM - 2:00 PM",
    services: ["Organic Waste Collection"],
    wasteTypes: ["Food Waste"],
  },
  {
    id: "bangar_waste_facility_002",
    name: "Ujong Jalan Waste Plant",
    category: "waste_facility",
    coordinates: [4.698, 115.059],
    address: "Ujong Jalan, Bangar PA1151",
    district: "Temburong",
    hours: "Mon-Fri: 8:00 AM - 4:00 PM",
    contact: "+673 877 1234",
    services: ["Waste Treatment", "Composting"],
    wasteTypes: ["Organic Waste", "General Waste"],
  },
  {
    id: "kilanas_collection_002",
    name: "Kilanas Community Collection",
    category: "collection_point",
    coordinates: [4.883, 114.87],
    address: "Kampong Kilanas, Jalan Kilanas",
    district: "Brunei-Muara",
    hours: "Tue-Sun: 7:00 AM - 7:00 PM",
    services: ["Scheduled Pickup", "Recyclables Collection"],
    wasteTypes: ["Paper", "Plastic", "Metal"],
  },
  {
    id: "mentiri_center_002",
    name: "Mentiri Recycling Center",
    category: "recycling_center",
    coordinates: [4.945, 114.995],
    address: "Mentiri Rimba, Jalan Mentiri",
    district: "Brunei-Muara",
    hours: "Mon-Fri: 8:00 AM - 4:00 PM",
    contact: "+673 211 0000",
    services: ["Plastic Recycling", "Glass Processing"],
