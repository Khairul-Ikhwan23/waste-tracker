...
export const rolePermissions = {
  ...
  Admin: {
    canAccess: ['dashboard', 'profile', 'pickup-requests', 'pickup-history', 'eco-rewards', 'eco-map', 'recycling-metrics', 'environmental-reports', 'route-planner', 'admin-facilities', 'payments', 'settings'],
    canViewOthers: true,
    canSchedule: true,
    canViewRoutes: true,
    canManageUsers: true,
